...
NeuralRNN contains the pipeline to model RNN for neuroscience research, including (1) constructing dataset, (2) building and configuring RNN models, (3) training, and (4) analysis based on the RNN models (See the full pipeline in **[`notebook`](notebook/README.md)**  and the documents in **[`docs`](docs/README.md)**). We also provide the guide to implement each built-in model using this framework (see **[`notebook`](notebook/README.md)**)
